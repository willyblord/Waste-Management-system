...
<head>
  ...
  <title>Musanze waste Point Management</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
                Musanze Waste Correction point
            </h3>
          </div>
            <div class="row">
            <div class="card">
            <div class="card-body">
              <h4 class="card-title">Musanze Waste Correction Point</h4>
              <div class="row">
                <div class="col-12">
                  <div class="responsive">
                    ...
                    <table  class="table" id="resultTable" cellspacing="0" width="100%">
                                     <?php
                    $selectAllUsers = $db->prepare("SELECT * FROM waste_range WHERE sector='Musanze'");
                    ...
                    if ($allUsersFound = $selectAllUsers->fetch()) {
                      ...
                      <tbody>
                        ...
                        ?>
                            <div class="alert alert-danger-lg">Musanze correction Point not found.</div>
                        <?php
                    }
                    ?>
                    </table>
