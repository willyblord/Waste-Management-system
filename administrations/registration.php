                ...
                <input name="lname" id="lname" placeholder="Last Name" type="text" class="form-control" required></div>
                        ...
                        <input name="password_2" id="password_2" placeholder="Lytype Password" type="password" class="form-control"  data-error=".errorTxt4" maxlength="12" required></div>
                                    ...
                                    <div class="mt-3 position-relative form-check">
                                        <input name="checkTermsAndConditions" id="exampleCheck" type="checkbox" class="form-check-input"><label for="exampleCheck" class="form-check-label">Accept our Terms and Conditions</a>.</label></div>
                                    <div class="mt-4 d-flex align-items-center"><h5 class="mb-0">Already have an account? <a href="index.php" class="text-primary">Sign in</a></h5>
                                        <div class="ml-auto">
                                            ...
                                            <button class="btn-wide btn-pill btn-shadow btn-hover-shine btn btn-primary btn-lg" name="registe" type="submit" > Create Account </button>
                            ...
                            <div class="slick-slider slick-initialized">
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                                        ...
                                        <div class="slider-content"><h3>Welcom Winners Mount Academy</h3>
                                            <p>Please Fill All!</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
