...
<script type="text/javascript">
        function populate(s1,s2){
            ...
            s2.innerHTML= "";
            if (s1.value == "Musanze") {
                var optionArray=["|","Cyabagarura|Cyabagarura","Garuka|Garuka","Garuka|Garuka","Kabazungu|Kabazungu","Nyarubuye|Nyarubuye","Rwambogo|Rwambogo"];
            }
...
<head>
  ...
  <title>Musanzesector User Management</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
                Select Reader of waste corrector in Musanze Sector
            </h3>
          </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="name" class="form-control">
                          <option>--Select Reader of Waste correctors--</option>
                                      <?php
                    $selectAllUsers = $db->prepare("SELECT * FROM employee WHERE role='Reader' AND sector='Musanze' limit 1");
