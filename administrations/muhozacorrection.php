...
<head>
  ...
  <title>Muhoza waste Point Management</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <div class="card-body">
              ...
              <h4 class="card-title">Muhoza Waste Correction Point</h4>
                ...
                <div class="col-12">
                  <div class="responsive">
                    ...
                    <table  class="table" id="resultTable" cellspacing="0" width="100%">
                                     <?php
                                     $i=1;
                    $selectAllUsers = $db->prepare("SELECT * FROM waste_range WHERE sector='Muhoza'");
