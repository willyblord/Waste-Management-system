...
<head>
  ...
  <title>Weekly Cleaners Employee Activities</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <div class="card">
            <div class="card-body">
              <h4 class="card-title">Weekly Employee Activities <span class="print" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"><BUTTON type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Print</BUTTON></span></h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table class="table">
                                         ...
                                         <?php
                                         $i=1;
                           $selectAllUsers=$db->prepare("SELECT * FROM schedule  WHERE YEARWEEK(inserted_date)= YEARWEEK(now()) ORDER BY inserted_date DESC");
