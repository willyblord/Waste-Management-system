      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
                Select Reader of waste corrector in cyuve
            </h3>
          </div>
...
<!--                         <option value="Muhoza">Muhoza</option>
 -->                    </select>
                      ...
                      <div class="form-group">
                        ...
                        <select name="name" class="form-control">
                          <option>--Select Reader of Waste correctors--</option>
                                      <?php
                    $selectAllUsers = $db->prepare("SELECT * FROM employee WHERE role='Reader' AND sector='Cyuve' limit 1");
                    ...
                    if ($allEmployeeFound = $selectAllUsers->fetch()) {
                        ...
                        ?>
                           <option><div class="alert alert-danger-lg"> No new Employee found.</div></option> 
                        <?php
                    }
                    ?>
                        </select>
