...
<script type="text/javascript">
        function populate(s1,s2){
            ...
            s2.innerHTML= "";
            if (s1.value == "Kimonyi") {
                var optionArray=["|","Birira|Birira","Buramira|Buramira","Kivumu|Kivumu","Mbizi|Mbizi"];
            }
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
                Select Reader of waste corrector in Kimonyi Sector
            </h3>
          </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="name" class="form-control">
                          <option>--Select Reader of Waste correctors--</option>
                                      <?php
                    $selectAllUsers = $db->prepare("SELECT * FROM employee WHERE role='Reader' AND sector='Kimonyi' limit 1");
