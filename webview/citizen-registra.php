  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 bg-light opacity-85" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.php"><img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logo-icon.png" alt="" width="50" /><span class="text-theme font-monospace fs-4 ps-2">E-waste</span></a>
      ...
      <section class="py-0" id="header">
        ...
        <div class="container">
          <div class="row align-items-center min-vh-75 min-vh-lg-100">
            ...
            <input name="name" id="name"  placeholder="First Name here..." type="text" class="fadeIn fourth" onkeypress="isInputText(event)">
            <input name="lname" id="lname"  placeholder="Last Name here..." type="text" class="fadeIn fourth" onkeypress="isInputText(event)">
            <input name="email" id="email" placeholder="Inter Email--" type="email" class="fadeIn fourth">
            <input name="phone" id="phone" placeholder="Inter phone--" type="text" class="fadeIn fourth" maxlength="10" minlength="10" onkeypress="isInputNumber(event)">

            <input name="username" id="username" placeholder="Username" type="text" class="fadeIn fourth">
            <input name="password_1" id="password" placeholder="password" type="password" class="fadeIn fourth">
            <input name="password_2" id="password_2" placeholder="Lytype Password" type="password" class="fadeIn fourth"> <br>
            <input type="checkbox" name="checkTermsAndConditions" id="exampleCheck" style="width: 20px; display: none;" checked >
            <button class="btn btn-lg btn-dark bg-gradient order-0" name="registerUser" id="registerButton" type="submit" >
              <br> Register </button>
